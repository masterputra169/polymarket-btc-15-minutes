...
def walk_forward_cv(X_tr: np.ndarray, y_tr: np.ndarray, cfg: dict,
                    w_tr: np.ndarray | None = None,
                    n_folds: int = DEFAULT_N_CV_FOLDS, return_preds: bool = False,
                    ...
                    *,
                    ...
                    early_stopping: int = DEFAULT_EARLY_STOPPING) -> tuple:
