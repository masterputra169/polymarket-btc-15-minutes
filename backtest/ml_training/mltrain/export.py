...
def build_browser_model(trees: list[dict],
                        *,
    ...
    return {
        ...
        'recency_weighting': {'enabled': recency_enabled, 'halflife_days': recency_halflife} if recency_enabled else None,
...
def build_norm_export(X_train_full: np.ndarray,
                      *,
                      feature_cols: list[str],
                      feature_cols_orig: list[str],
                      platt_a: float,
                      ...
                      phase_thresholds: dict[str, dict[str, float]] | None,
                      holdout_frac: float | None,
                      holdout_start_idx: int | None) -> dict:
