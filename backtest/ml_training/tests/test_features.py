...
BASE_FEATURES = [
    'delta_1m_pct', 'delta_3m_pct', 'rsi_norm', 'rsi_slope', 'vwap_dist', 'vwap_slope',
    'macd_line', 'macd_hist', 'bb_percent_b', 'bb_squeeze', 'atr_pct_norm', 'stoch_k_norm',
    'vol_ratio_norm', 'vol_delta_buy_ratio', 'ha_is_green', 'ha_signed_consec',
    'ema_cross_signal', 'ema_dist_norm', 'multi_tf_agreement', 'regime_trending',
    'regime_mean_reverting', 'regime_confidence', 'market_price_momentum',
    'orderbook_imbalance', 'crowd_model_divergence', 'rule_confidence',
]
