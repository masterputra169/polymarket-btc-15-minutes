export const ML_CONFIDENCE = { HIGH: 0.58, MEDIUM: 0.20 } as const;  // H3: aligned with MIN_ML_CONFIDENCE=0.58 — edge boost kicks in at same level as filter gate

export const WS_DEFAULTS = { throttleMs: 500, reconnectMaxMs: 10_000, heartbeatCheckMs: 10_000 } as const;
export const WS_BINANCE = { heartbeatDeadMs: 20_000, heartbeatCheckMs: 5_000 } as const;
export const WS_CHAINLINK = { pingMs: 15_000, heartbeatDeadMs: 45_000 } as const;
export const WS_POLYMARKET_LIVE = { pingMs: 15_000, heartbeatDeadMs: 30_000 } as const;
export const WS_CLOB = { heartbeatDeadMs: 15_000, subWatchdogMs: 5_000, dataStaleMs: 20_000 } as const;
 ...
 */
export function polyFeeRate(price: number): number {
