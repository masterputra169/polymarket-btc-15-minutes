...
import { ensureLoaded, markDirty, MAX_HISTORY, clearPersistTimer } from './state.ts';
import * as S from './state.ts';
import { extractSignalSnapshot, updateSignalPerf } from './signalPerf.ts';
 ...
 */
export function recordPrediction({ side, modelProb, marketPrice, btcPrice, priceToBeat, marketSlug, regime, mlConfidence, mlSide, breakdown }: any) {
  ensureLoaded();
