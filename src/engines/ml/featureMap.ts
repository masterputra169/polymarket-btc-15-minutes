...
export const FI = {
  ...
  best_edge: 15, regime_trending: 16, regime_confidence: 17,
  ...
  volume_acceleration: 40, bb_squeeze_intensity: 41,
...
export function resolveFeatureIdx(splitName: string): number {
