...
export type MarketRegime = 'trending' | 'choppy' | 'mean_reverting' | 'moderate';
export type RegimeDirection = 'UP' | 'DOWN' | null;

export interface RegimeParams {
  price: number | null | undefined;
  vwap: number | null | undefined;
  vwapSlope: number | null | undefined;
  vwapCrossCount: number | null | undefined;
  volumeRecent: number | null | undefined;
  volumeAvg: number | null | undefined;
  atrRatio?: number | null;
  volumeRatioOverride?: number | null;
  acf?: number | null;
}
 ...
 */
export function computeAutocorrelation(closes: number[] | null | undefined): number | null {
...
export function detectRegime({
  ...
  volumeAvg,
  atrRatio = null,
  volumeRatioOverride = null,
  acf = null,
}: RegimeParams): RegimeInfo {
  let regime: MarketRegime = 'moderate';
  let confidence = 0.5;
  let label = 'Moderate';
  let direction: RegimeDirection = null; // 'UP', 'DOWN', or null (non-directional)
