...
export type VolatilitySession = 'EU/US Overlap' | 'US' | 'Europe' | 'Asia' | 'Off-hours';
export type VolatilityLevel = 'very_high' | 'high' | 'medium' | 'low' | 'very_low';

export interface PtbThresholds {
  strong: number;
  moderate: number;
  slight: number;
}
 ...
 */
export function getVolatilityProfile(now = new Date()): VolatilityProfile {
