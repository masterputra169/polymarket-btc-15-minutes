...
export interface HeikenAshiCandle extends OhlcCandle {
  isGreen: boolean;
  body: number;
}

export interface ConsecutiveHeikenAshiResult {
  color: 'green' | 'red' | null;
  count: number;
}

export function computeHeikenAshi(
  candles: OhlcCandle[] | null | undefined
): HeikenAshiCandle[] {
...
export function countConsecutive(
  haCandles: HeikenAshiCandle[] | null | undefined
): ConsecutiveHeikenAshiResult {
