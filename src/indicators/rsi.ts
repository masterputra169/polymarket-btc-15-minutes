...
export { sma, slopeLast } from './math.ts';
 ...
 */
export function computeRsi(closes: number[] | null | undefined, period = 8): number | null {
 ...
 */
export function computeRsiSeries(closes: number[] | null | undefined, period = 8): number[] {
