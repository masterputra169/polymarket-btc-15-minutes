...
import { computeRsiSeries } from './rsi.ts';

export type StochRsiZone = 'OVERBOUGHT' | 'OVERSOLD' | 'NEUTRAL';
export type StochRsiSignal = 'BULLISH' | 'BEARISH' | 'LEAN_BULLISH' | 'LEAN_BEARISH' | 'NEUTRAL';
...
export interface StochRsiSignalResult {
